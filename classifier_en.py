...
with open('csv/en/train/sim_en.csv', 'rU') as infile:
...
# get testset
test_corp = ""
with open('csv/en/test/sim_en.csv', 'rU') as infile_t:
    # read the file as a dictionary for each row ({header : value})
...
print("Cosine Similarity of English doc: ", cosine_similarity(vector_1_sent, vector_2_sent))
